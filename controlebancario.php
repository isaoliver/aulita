 ...
 <tr> _ _
     ...
     <td> _ _
         < selecione  nome = " banco " >
             ...
             < valor da opção  = " brasil " > Banco do Brasil </ opção >  
             < valor da opção  = " marcentil " > Banco marcentil </ opção > 
...
< td >< label  for = " cpf " > CPF :</ label </ td >
   ...
   < td >< tipo de entrada  = " texto " nome = " cpf " tamanho necessário = " 14 " maxlength = " 14 " > < /    
